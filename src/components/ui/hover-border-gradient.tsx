...
>) {
  ...
  const themeColor = 'oklch(0.714 0.1606 214.04)';

  const movingMap: Record<Direction, string> = {
    TOP: `radial-gradient(20.7% 50% at 50% 0%, ${themeColor} 0%, transparent 100%)`,
    LEFT: `radial-gradient(16.6% 43.1% at 0% 50%, ${themeColor} 0%, transparent 100%)`,
    BOTTOM: `radial-gradient(20.7% 50% at 50% 100%, ${themeColor} 0%, transparent 100%)`,
    RIGHT: `radial-gradient(16.2% 41.2% at 100% 50%, ${themeColor} 0%, transparent 100%)`,
  };

  const highlight = `radial-gradient(75% 181% at 50% 50%, ${themeColor} 0%, transparent 100%)`;
